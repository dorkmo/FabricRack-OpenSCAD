...
translate([(X/2)+0.5,Y-(g*2)-1-g-1-(((h/10)*2.2)+(Z*2))-1-1,0])
BraceLock();
...
module Brace(){
    difference(){
    cube([W,(h/10)*2.2+(Z*2),Z]);
        
    cube([(W/2)-(w/2)-o,(h/10)*2.2+(Z*2),Z]); //cut off side
    ...
    mirror([1,0,0])
    cube([z+o,(h/10)*2.2-(Z*3*1.75*2),Z]);
    translate([(W/2)+(w/2)-z,Z*3*1.75,0])
    cube([z+o,(h/10)*2.2-(Z*3*1.75*2),Z]);

    translate([(W/2)+(w/2),(h/10)*2.2,0])
    mirror([1,0,0])
    cube([z,Z*2,Z]);
    translate([(W/2)-(w/2),(h/10)*2.2,0])
    cube([z,Z*2,Z]);
    ...
    toolRadius((W/2)-(w/2)+z, (h/10)*2.2+(Z*2) - D/2);
    toolRadius((W/2)+(w/2)-z, (h/10)*2.2+(Z*2) - D/2);
    toolRadius((W/2)-(w/2), (h/10)*2.2+(Z*2) - D/2);
    toolRadius((W/2)+(w/2), (h/10)*2.2+(Z*2) - D/2);
...
module BraceLock(){
   difference(){
   cube ([Z*6,(((h/10)*2.2)-(Z*3*1.75*2)),Z]); 
   cube ([(Z*6)-o,(((h/10)*2.2)-(Z*3*1.75*2))/2,Z]);
   
   // Tool radius compensation for concave corners (semicircular cuts)
   toolRadius((Z*6)-o, (((h/10)*2.2)-(Z*3*1.75*2))/2 - D/2);
}
}
